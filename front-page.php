  ...
  <div class="row">
    ...
    <div class="col-4">
          <div class="card text-white bg-secondary mb-3" style="max-width: 25rem;">
            <div class="card-header"> <img class="rounded-circle" src="<?php echo get_theme_mod('moduler_client_1_img', get_bloginfo('template_url').'/assets/placeholder_face.png'); ?>" height="50" width="50" style="padding: 5px"><?php echo get_theme_mod('moduler_client_1_name', __('Tasnimul H. Tauhid', 'moduler')); ?></div>
            <div class="card-body">
    ...
    <div class="col-4">
          <div class="card text-white bg-secondary mb-3" style="max-width: 25rem;">
            <div class="card-header"> <img class="rounded-circle" src="<?php echo get_theme_mod('moduler_client_2_img', get_bloginfo('template_url').'/assets/placeholder_face.png'); ?>" height="50" width="50" style="padding: 5px"><?php echo get_theme_mod('moduler_client_2_name', __('Tasnimul H. Tauhid', 'moduler')); ?></div>
            <div class="card-body">
    ...
    <div class="col-4">
          <div class="card text-white bg-secondary mb-3" style="max-width: 25rem;">
            <div class="card-header"> <img class="rounded-circle" src="<?php echo get_theme_mod('moduler_client_3_img', get_bloginfo('template_url').'/assets/placeholder_face.png'); ?>" height="50" width="50" style="padding: 5px"><?php echo get_theme_mod('moduler_client_3_name', __('Tasnimul H. Tauhid', 'moduler')); ?></div>
            <div class="card-body">
  ...
  <div class="row">
    ...
    <div class="col-4">
          <div class="card text-white bg-secondary mb-3" style="max-width: 25rem;">
            ...
            <img class="card-img-top rounded-circle" src="<?php echo get_theme_mod('moduler_team_member_1_img', get_bloginfo('template_url').'/assets/face1.png'); ?>" style="padding: 25px" >
    ...
    <div class="col-4">
          <div class="card text-white bg-secondary mb-3" style="max-width: 25rem;">
            <img class="card-img-top rounded-circle" src="<?php echo get_theme_mod('moduler_team_member_2_img', get_bloginfo('template_url').'/assets/placeholder_face.png'); ?>" style="padding: 25px">
            <div class="card-header">
    ...
    <div class="col-4">
          <div class="card text-white bg-secondary mb-3" style="max-width: 25rem;">
            <img class="card-img-top rounded-circle" src="<?php echo get_theme_mod('moduler_team_member_3_img', get_bloginfo('template_url').'/assets/placeholder_face.png'); ?>" style="padding: 25px">
            <div class="card-header">
